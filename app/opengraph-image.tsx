...
// Image metadata
export const alt = "GhibliStyle Converter - Transform Photos into Studio Ghibli Art";
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function Image() {
  return new ImageResponse(
    <div
      style={{
        fontSize: 60,
        background: "linear-gradient(135deg, #1C2E1C 0%, #2F4538 40%, #3A4F3D 70%, #1A2818 100%)",
        width: "100%",
        height: "100%",
        display: "flex",
